...
<head>
  ...
  <title>Nicholas Tjhung | IAM Portfolio</title>
...
<main class="container">
  ...
  <section class="hero">
    ...
    <aside class="profile-card">
      ...
      <!-- Later, if you upload a headshot, replace the avatar above with this:
  ...
  <section class="section">
    ...
    <p class="section-subtitle">
      Hands-on identity and access management projects built to demonstrate job-ready Microsoft Entra ID, Okta, PowerShell, Microsoft Graph, IAM documentation, audit evidence, and security administration skills.
    </p>

    <div class="project-grid">

      <article class="project-card">
        <img src="assets/entra-lifecycle/users-list.png" alt="Entra ID users list screenshot" class="project-thumb">
        ...
        <div class="project-content">
          ...
          <div class="card-actions">
            <a class="card-link" href="case-studies/entra-lifecycle.md">View Case Study →</a>
          </div>
        </div>
      </article>

      <article class="project-card">
        <img src="assets/conditional-access/ca-license-warning.png" alt="Conditional Access licensing warning screenshot" class="project-thumb">
        ...
        <div class="project-content">
          ...
          <div class="card-actions">
            <a class="card-link" href="case-studies/conditional-access.md">View Case Study →</a>
          </div>
        </div>
      </article>

      <article class="project-card">
        <img src="assets/access-review/finance-access-review-members.png" alt="Finance access review members screenshot" class="project-thumb">
        ...
        <div class="project-content">
          ...
          <div class="card-actions">
            <a class="card-link" href="case-studies/access-review.md">View Case Study →</a>
          </div>
        </div>
      </article>

      <article class="project-card">
        <img src="assets/okta/okta-app-group-assignment.png" alt="Okta app group assignment screenshot" class="project-thumb">
        ...
        <div class="project-content">
          ...
          <div class="card-actions">
            <a class="card-link" href="case-studies/okta.md">View Case Study →</a>
          </div>
        </div>
      </article>

      <article class="project-card">
        <img src="assets/graph-reporting/group-membership-report-preview.png" alt="Microsoft Graph group membership report preview screenshot" class="project-thumb">
        ...
        <div class="project-content">
          ...
          <div class="card-actions">
            <a class="card-link" href="case-studies/graph-reporting.md">View Case Study →</a>
          </div>
        </div>
      </article>
  ...
  <section class="section">
    <div class="skill-panel">
      ...
      <div class="badge-row">
        ...
        <span class="badge">PowerShell</span>
        <span class="badge">MFA</span>
        <span class="badge">Conditional Access Planning</span>
        <span class="badge">Access Reviews</span>
        <span class="badge">Identity Governance</span>
        <span class="badge">RBAC</span>
        <span class="badge">Group-Based Access Control</span>
        <span class="badge">User Provisioning</span>
        <span class="badge">Deprovisioning</span>
        <span class="badge">IAM Documentation</span>
        <span class="badge">Audit Evidence</span>
  ...
  <section class="section">
    ...
    <p class="section-subtitle">
      Microsoft identity, cloud administration, security architecture, and project delivery certifications.
    </p>
  ...
  <section class="section">
    <div class="skill-panel">
      <h2 class="section-title">Recruiter Summary</h2>
      <p class="section-subtitle">
        Open to remote IAM Analyst, Identity Governance, Entra ID Administrator, Okta Administrator, Microsoft 365 Administrator, and Security Administration roles.
      </p>

      <div class="cta-row">
        <a class="btn btn-primary" href="projects.html">See Project Work</a>
        <a class="btn btn-secondary" href="resume.html">View Resume</a>
